...
- [rkforge-sandbox-runtime-release.yml](/home/erasernoob/project/rk8s/.github/workflows/rkforge-sandbox-runtime-release.yml)

## Installer Integration

The root installer (`/home/erasernoob/project/rk8s/install.sh`) now attempts to install
